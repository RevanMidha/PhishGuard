...
export default function Dashboard() {
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="mb-6 rounded-3xl border border-slate-800 bg-slate-900/40 p-5 backdrop-blur-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-950/60 px-3.5 py-2.5 text-sm text-slate-400">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
        <div className="bg-slate-900/40 border border-slate-800 p-5 rounded-2xl backdrop-blur-sm relative overflow-hidden">
        ...
        {MODULES.map((module) => {
          ...
          return (
            <div
              ...
              className="group bg-gradient-to-b from-slate-800/40 to-slate-900/40 border border-slate-700/50 p-5 rounded-2xl hover:border-slate-600 transition-all cursor-pointer relative overflow-hidden"
            >
